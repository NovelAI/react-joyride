...
function getMergedStep(step, props) {
  ...
  var floaterProps = deepmerge__default["default"].all([props.floaterProps || {}, DEFAULTS.floaterProps, mergedStep.floaterProps || {}]); // Set react-floater props
...
var JoyrideOverlay = /*#__PURE__*/function (_React$Component) {
  ...
  function JoyrideOverlay() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMouseMove", function (e) {
      ...
      var isInAnySpotLight = _this.spotlightStyles.some(function (spotlightStyle) {
        var height = spotlightStyle.height,
            left = spotlightStyle.left,
            position = spotlightStyle.position,
      ...
      if (isInAnySpotLight !== mouseOverSpotlight) {
        _this.updateState({
          mouseOverSpotlight: isInAnySpotLight
        });
      }
    });
  ...
  _createClass(JoyrideOverlay, [{
    ...
    get: function get() {
      ...
      var elements = typeof target === 'string' ? _toConsumableArray(document.querySelectorAll(target)) : [target];
    ...
    value: function render() {
      ...
      var spotlights = this.spotlightStyles.map(function (spotlightStyle, index) {
